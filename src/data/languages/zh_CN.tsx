...
export default {
	...
	characterInfo: {
		Michele: {
			...
			skillTacticalName: `破法喵喵`,
			skillTacticalDescription: `米雪儿抛出能附着在建筑表面的破法喵喵，破法喵喵可被米雪儿主动激活，并在短暂延迟后对周围敌人造成沉默效果。`,
		},
		Nobunaga: {
			Name: "信",
			Type: "守护",
			...
			skillTacticalName: `脉冲地雷`,
			skillTacticalDescription: `信向目标方向投出一个地雷，地雷部署完毕后会进入敌方靠近后才会显形的隐身状态，当地雷检测到敌人后会引爆并对范围内的敌人造成持续伤害。`,
		},
		Kokona: {
			Name: "心夏",
			Type: "支援",
			...
			skillTacticalName: `医疗站点`,
			skillTacticalDescription: `心夏可以定点部署一个治疗无人机，无人机会制造一大片治疗场，处在区域内的队友会持续恢复生命值，该恢复效果不会被伤害中断。`,
		},
		Yvette: {
			Name: "伊薇特",
			Type: "控场",
			...
			skillTacticalName: `坚坚冰柱`,
			skillTacticalDescription: `伊薇特可以投掷出一个冰球，冰球落在地面后会在落点生成一块巨大的冰柱，冰柱拥有高额生命值且会阻挡敌我双方的子弹，站在冰柱附近的敌人会受到打滑和易伤的效果，冰柱无法在有角色或召唤物的地方生成。`,
		},
		Flavia: {
			Name: "芙拉薇娅",
			Type: "决斗",
			...
			skillTacticalName: `遁入幻境`,
			skillTacticalDescription: `芙拉薇娅引动弦能，以自身为中心生成遮蔽视野的烟雾。芙拉薇娅可以在化蝶状态使用该技能，这样做将立即解除化蝶状态。`,
		},
		Yugiri: {
			Name: "忧雾",
			Type: "控场",
			...
			skillTacticalName: `腐蚀溶液`,
			skillTacticalDescription: `忧雾向目标区域投掷毒液装置，毒液装置落地时会爆开并制造一片腐蚀区域，对区域内的敌人造成伤害与减速效果，弦化状态的敌人受到额外伤害。`,
		},
		Leona: {
			Name: "蕾欧娜",
			Type: "守护",
		...
		Ming: {
			...
			skillTacticalName: `爆闪电球`,
			skillTacticalDescription: `明可以发射一个闪光电球，再次按下技能键后或是到达最大飞行时间后引爆，并对周围所有敌人造成致盲效果，引爆前有一段延迟，延迟期间内闪光电球可以被摧毁。`,
		},
		Lawine: {
			Name: "拉薇",
			Type: "先锋",
			...
			skillTacticalName: `闪影猎刃`,
			skillTacticalDescription: `拉薇可以扔出一把闪光脉冲刀，脉冲刀插在障碍物上后引爆，并对周围所有敌人造成致盲效果，引爆前有一段延迟，延迟期间内飞刀可以被摧毁。`,
		},
		Meredith: {
			Name: "梅瑞狄斯",
			Type: "控场",
			...
			skillTacticalName: `盲眼迷沙`,
			skillTacticalDescription: `梅瑞狄斯向目标方向发射弦能球体，于落点处创造一片完全遮蔽视野的环状黄沙领域。`,
		},
		Reiichi: {
			Name: "令",
			Type: "控场",
			...
			skillTacticalName: `圣屏突进`,
			skillTacticalDescription: `令释放一个可以向前推进的光幕，该光幕在准备释放阶段能够设置最终落点。`,
		},
		Kanami: {
			Name: "香奈美",
			Type: "先锋",
			...
			skillTacticalName: `律动旋风`,
			skillTacticalDescription: `香奈美可以扔出一个迷你音响，制造一大片声风场区域，该风场会将所有进入风场内的角色吹起。在被吹起期间，敌方角色受到晕眩效果，友方角色获得移速提升效果，上述效果在离开风场区域后还会持续一段时间。`,
		},
		Eika: {
			Name: "艾卡",
			Type: "决斗",
			...
			skillTacticalName: `爆焰热弹`,
			skillTacticalDescription: `艾卡可以快速丢出一枚爆焰火球，火球落地时造成伤害，对弦化状态的敌人造成额外伤害。消耗100热量所获增益：提升伤害并附带减速效果。`,
		},
		Fragrans: {
			Name: "珐格兰丝",
			Type: "支援",
			...
			skillTacticalName: `香语众氛`,
			skillTacticalDescription: `珐格兰丝投掷出一瓶治疗香水，治疗香水触碰到障碍物时爆炸生效，制造一片回复生命区域，进入区域内的人会被赋予一段缓慢回复生命效果，即使离开区域也会持续一段时间。`,
		},
		Mara: {
			Name: "玛拉",
			Type: "决斗",
		...
		Celestia: {
			...
			skillTacticalName: `塑甲星芒`,
			skillTacticalDescription: `星绘向目标区域掷出星芒，星芒触碰到障碍物时爆炸生效，制造一片回复护甲区域，进入区域内的人会被赋予一段缓慢回复护甲效果，即使离开区域也会持续一段时间。`,
		},
		Audrey: {
			Name: "奥黛丽",
			Type: "守护",
			...
			skillTacticalName: `警报雷达`,
			skillTacticalDescription: `奥黛丽丢出一个警报雷达，雷达落地后展开并对周围持续进行扫描，扫描到敌人时提示敌人的数量并对敌人施加短暂透视效果。`,
		},
		Maddelena: {
			Name: "玛德蕾娜",
			Type: "控场",
			...
			skillTacticalName: `颜料泡涌`,
			skillTacticalDescription: `玛德蕾娜向前方发射颜料泡，再次按下技能键后颜料泡会停留在原地，颜料泡会对碰到的敌人造成减速和弦化禁止效果。`,
		},
		Fuchsia: {
			Name: "绯莎",
			Type: "决斗",
			...
			skillTacticalName: `猩红猛冲`,
			skillTacticalDescription: `绯莎消耗当前一定百分比生命值，获得移速提升效果，持续一段时间。`,
		},
		BaiMo: {
			Name: "白墨",
			Type: "决斗",
			...
			skillTacticalName: `爆炸涂鸦`,
			skillTacticalDescription: `白墨快速向前投掷出颜料罐，颜料罐爆炸时对周围敌人造成禁止弦化效果。`,
		},
		Galatea: {
			Name: "加拉蒂亚",
			Type: "先锋",

                    ...
                    content={<Card style={{ width: '500px', height: "100%", margin: "0 auto", overflow: "hidden" }}>
                      <div style={{ display: "flex", height: "100%" }}>
                        <div style={{ height: "360px", width: "200px", margin: "0 auto", display: "relative" }}>
                          <img draggable="false" src={import.meta.env.BASE_URL + "images/remote/abecb25a_iD1g23pnC9d6hVM.png"} style={{ height: "360px", filter: "drop-shadow(0 0 5px rgba(var(--semi-grey-7))" }} />
                          <div style={{ position: "absolute", left: "40px", bottom: "60px", height: "25px", display: "flex", alignContent: "center", filter: "drop-shadow(0 0 5px rgba(var(--semi-grey-7))" }}>
                            <img draggable="false" src={import.meta.env.BASE_URL + "images/remote/5b67126e_c7QDINMXFyuav6b.png"} style={{ filter: "invert(100%)", height: "25px" }} />
